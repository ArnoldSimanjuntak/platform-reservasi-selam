                                ...
                                {serviceTypes.map((st) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {isActive && (
                                                <div className="absolute top-3 right-3 w-5 h-5 rounded-full bg-white border-2 border-current flex items-center justify-center" style={{ color: st.text.includes("blue") ? "#1d4ed8" : st.text.includes("emerald") ? "#047857" : "#b45309" }}>
