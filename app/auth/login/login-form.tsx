            ...
            <div className="relative z-10 w-full max-w-md mx-4">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-blue-200 mt-2">
                        Masuk ke akun Sulut<span className="text-cyan-300">Dive</span> Anda
                    </p>
                </div>
                ...
                >
                    {/* Success Message */}
                    {message && (
                        <div className="mb-6 p-4 rounded-xl bg-green-500/20 border border-green-400/30 text-green-200 text-sm flex items-start gap-3">
                            <div className="w-5 h-5 rounded-full bg-green-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
